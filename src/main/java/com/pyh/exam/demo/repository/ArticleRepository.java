...
public interface ArticleRepository {
	public void writeArticle(@Param("memberId") int memberId, @Param("boardId") int boardId, @Param("title") String title, @Param("body") String body); // INSERT 쿼리는 값이 삽입되는 것이므로 리턴을 안해줌. 그러므로 타입을 void로 바꾸기
